...
from minigrid.envs.wfc.wfc_logic import wfc_control, wfc_solver
...
class WFCConfig:
    ...
    def wfc_kwargs(self):
        kwargs = asdict(self)
        kwargs["image"] = imageio.v2.imread(kwargs.pop("template_path"))[:, :, :3]
        return kwargs


WFC_PRESETS = {
    "SimpleMaze": WFCConfig(template_path=TEMPLATE_PATH / "SimpleMaze.png", tile_size=1, pattern_width=2,
...
class WFCEnv(MiniGridEnv):
    ...
    def _get_largest_component(self, graph: nx.Graph) -> nx.Graph:
